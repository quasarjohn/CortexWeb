...
function ajax_classify_image() {
    ...
    $.ajax({
        ...
        url: "http://192.168.0.140:8091/api/user1/classifier/upload_classify_image/modelkey",
        data: data,
...
function classifyImageFromURL(img_url) {
     ...
     */
    xhr.open('GET', "http://192.168.0.140:8091/api/user1/classifier/classify_image/xxx?img_url=" +
